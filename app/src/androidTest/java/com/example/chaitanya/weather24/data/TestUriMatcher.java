...
public class TestUriMatcher extends AndroidTestCase {
    ...
    private static final Uri TEST_LOCATION_DIR = WeatherContract.LocationEntry.COTENT_URI;
    ...
    public void testUriMatcher() {
        ...
        assertEquals("Error: The WEATHER WITH LOCATION URI was matched Incorrectly.", testMatcher.match(TEST_WEATHER_WITH_LOCATION_DIR),
                WeatherProvider.WEATHER_WITH_LOCATION);
        assertEquals("Error: The WEATHER WITH LOCATION AND DATE URI was matched Incorrectly.", testMatcher.match(TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR),
