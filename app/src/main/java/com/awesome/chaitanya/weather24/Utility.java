...
public class Utility {
    ...
    public static String formatTemperature(Context context, double temperature) {
        /**
         * Data stored in Celsius by default. If user prefers to see in Fahrenheit,
        ...
        //for presentation, assume the users doesn't care about tenths of a degree.
    ...
    /**
     * Format used for storing dates in database. Also used for converting
     * those strings back into date objects for comparisons/processing.
     */
    public static final String DATE_FORMAT = "yyyyMMdd";

    /**
     * Helper method to convert the database representation of the date into something to display
     * to users. As classy and polished a ser experience as "20140102" is, we can do better
     */
    public static String getFriendlyDayString(Context context, long dateInMillis, boolean displayLongToday) {
        /**
         * The day string for forecast uses the following logic:
         * For Today: "Today, May 30"
         * For Tomorrow: "Tomorrow"
         * For the next 5 days : "Friday" (just the day name)
         * For all days after that: "Mon June 6"
         */
        Time time = new Time();
        time.setToNow();
     ...
     */
    public static String getFullyFriendlyDayString(Context context, long dateInMillis) {
    ...
    public static int getIconResourceForWeatherCondition(int weatherId) {
         ...
         * https://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_codes
         */
    ...
    /**
     * Helper method to return whether or not Weather24 is local graphics.
     * @param context Context to use for retrieving the preference
     * @return true is weather24 is using local graphics, false otherwise
     */
    public static boolean usingLocalGraphics(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String weather24ArtPack = context.getString(R.string.pref_art_pack_weather24);
        return prefs.getString(context.getString(R.string.pref_art_pack_key), weather24ArtPack).equals(weather24ArtPack);
    }

    /**
     * Helper method to provie the art urls according to the weather condition id returned
     * bu the OpenWeatherMap call.
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String formatArtUrl = prefs.getString(context.getString(R.string.pref_art_pack_key), context.getString(R.string.pref_art_pack_weather24));
    ...
    /**
     * Helper method to provide the string according to the weather condition id
     * returned by the OpenWeatherMap Call.
     * @param context context to use for retrieving the URL format
     * @param weatherId from OpenWeatherMap API response
     * @return url for the corresponding weather condition. null if no relation is found.
     */
    ...
    /**
     * Helper method to provide the correct image according to the weather condition id
     * returned by the OpenWeatherMap call.
     */
    ...
    static public @WeatherSyncAdapter.LocationStatus
    int getLocationStatus(Context c) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        return sp.getInt(c.getString(R.string.pref_location_status_key), WeatherSyncAdapter.LOCATION_STATUS_UNKNOWN);
    }
    ...
    static public void resetLocationStatus(Context c) {
        ...
        spe.putInt(c.getString(R.string.pref_location_status_key), WeatherSyncAdapter.LOCATION_STATUS_UNKNOWN);
        spe.apply();
    }
}
