...
import com.awesome.chaitanya.weather24.BuildConfig;
import com.awesome.chaitanya.weather24.MainActivity;
import com.awesome.chaitanya.weather24.R;
import com.awesome.chaitanya.weather24.Utility;
import com.awesome.chaitanya.weather24.data.WeatherContract;
import com.awesome.chaitanya.weather24.muzei.WeatherMuzeiSource;
...
public class WeatherSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    //these indices must watch the projection
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                /**
                 * since it's JSON, adding a new line isn;t necessary, but it does make
                 * debugging a lot easier if you print out the completed buffer for debugging
                 */
                buffer.append(line + "\n");
            }
            if (buffer.length() == 0) {
     ...
     * pull out the data we need wo construct the strings needed for the wireframes.
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting) throws JSONException {
        ...
        try {
            ...
            //insert the new weather information into database
             ...
             * we're going to take advantage of that to get a nice normalized UTC date for all
             * our weather.
             */
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                weatherValues.put(WeatherContract.WeatherEntry.CLOUMN_SHORT_DESC, description);
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    String contextText = String.format(context.getString(R.string.format_notification), desc,
     ...
     * @param cityName A human-readable city name e.g "San Jose"
     * @param lat the latitude of city
     * @param lon the longitude of city
     * @return the row of ID of the added location
     */
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCursor = getContext().getContentResolver().query(WeatherContract.LocationEntry.COTENT_URI,
        ...
        if (locationCursor.moveToFirst()) {
            ...
            /**
             * Then addthe data, along with the corresponding name of the data type,
            ...
            Uri insertedUri = getContext().getContentResolver().insert(WeatherContract.LocationEntry.COTENT_URI, locationValues);
    ...
    /**
     * Helper method to get fake account to be used with SyncAdapter, or make a new one
    ...
    public static Account getSyncAccount(Context context) {
        ...
        //get instance of the Android account manager
        ...
        if (null == accountManager.getPassword(newAccount)) {
            /**
             * add the account and account tyoe, no password or user data
             * If successful, return account object, otherwise report an error.
             */
