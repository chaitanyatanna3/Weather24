...
public class WeatherProvider extends ContentProvider {
    ...
    static {
        ...
        /**
         * this is an iner join which looks like weather INNER JOIN location on weather.location_id = location._id
         */
    ...
    private Cursor getWeatherByLocationSetting(Uri uri, String[] projection, String sortOrder) {
        ...
        return sWeatherByLocationSettingQueryBuilder.query(mOpenHelper.getReadableDatabase(), projection, selection,
