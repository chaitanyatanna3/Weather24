...
public class SettingsActivity extends PreferenceActivity implements Preference.OnPreferenceChangeListener,
    ...
    /**
     * Register a shared preference change listener that gets notified when preferences change
     */
    @Override
...
//        }
    ...
    /**
     * This gets called after the preference is changed , which is important because
     * we start our synchronization here
     */
    @Override
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(R.string.pref_location_key))) {
             ...
             * Wipe out any potential plcae picker latlng values so that
             * we use this text entry
             */
            ...
            //remove attributions for our any place picker locations.
            ...
            //our location status has has changed. update the summary accordingly
