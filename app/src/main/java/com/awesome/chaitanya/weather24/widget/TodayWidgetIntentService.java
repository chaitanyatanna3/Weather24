package com.awesome.chaitanya.weather24.widget;
...
public class TodayWidgetIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            //Content description for RemoteViews were only added in ICS MR1
    ...
    private int getWidgetWidth(AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        /**
         * For Jelly Bean and highere devices, widgets can be resized - the current size can
         * be retrieved from the newly add App Widget Options
         */
