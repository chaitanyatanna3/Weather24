...
/**
 * Defines table and columns for the weather database.
 */
public class WeatherContract {
     ...
     */
    public static final String CONTENT_AUTHORITY = "com.example.chaitanya.weather24";
    ...
    /**
     * possible paths
     * for instance, content://com.example.chaitanya.weather24/weather/ is a valid path for
     * looking at weather data. content://com.example.chaitanya.weather24/givemeroot wiil fail,
     * as the content provider hasn't been given any information on what to do with "givemeroot".
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        public static final Uri COTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_LOCATION).build();
        ...
        /**
         * human readable location string, provided by the API. because for styling, "San Jose" is more recongnizable than 95132
         */
        public static final String COLUMN_CITY_NAME = "city_name";

        /**
         * in order ti uniquely pinpoint the location on the map when we launch the map intent, we store the latitude and longitude
        ...
        public static Uri buildLocationUri(long id) {
            return ContentUris.withAppendedId(COTENT_URI, id);
        }
    }
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static final String CLOUMN_SHORT_DESC = "short_desc";
